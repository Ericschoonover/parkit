...
const areas = [
  { name: "Landover", near: "NW Stadium", listings: "15+" },
  { name: "Capitol Heights", near: "NW Stadium", listings: "10+" },
...
export default function HomePage() {
  return (
    <div className="flex flex-col">
      {/* Hero Section */}
      <section className="relative bg-gradient-to-br from-[#773141] via-[#5A1A28] to-[#1C0A0E] text-white overflow-hidden">
        ...
        <div className="container mx-auto px-4 py-20 lg:py-32 relative">
          <div className="max-w-3xl">
            ...
            <h1 className="text-4xl lg:text-6xl font-bold mb-6 leading-tight">
              Parking Near
              <br />
              <span className="text-[#D4A574]">Northwest Stadium?</span>
              <br />
              We&apos;ve Got You.
            </h1>
            <p className="text-lg lg:text-xl text-white/80 max-w-xl mb-8 leading-relaxed">
              Skip the $40-60 stadium lots. Rent driveways, garages, and private spots
              from real people near the Commanders, Capital One Arena, and more.
            </p>
            <div className="flex flex-col sm:flex-row gap-4">
              <LinkButton size="lg" href="/search" className="bg-white text-[#773141] hover:bg-white/90 text-base">
      ...
      <section className="py-16 lg:py-24 bg-background">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-muted-foreground max-w-lg mx-auto">Stress-free parking for every game and concert in the DMV</p>
          </div>
          <div className="grid md:grid-cols-3 gap-8">
            <div className="text-center p-6 rounded-2xl border bg-card hover:shadow-lg transition-shadow">
              <div className="w-14 h-14 bg-[#D4A574]/10 rounded-2xl flex items-center justify-center mx-auto mb-4">
                <MapPin className="h-7 w-7 text-[#773141]" />
              </div>
              <h3 className="text-lg font-semibold mb-2">Find a Spot</h3>
              <p className="text-muted-foreground text-sm leading-relaxed">
                Search by venue or neighborhood. See real-time prices from homeowners near Northwest Stadium and DC venues.
              </p>
            </div>
            <div className="text-center p-6 rounded-2xl border bg-card hover:shadow-lg transition-shadow">
              <div className="w-14 h-14 bg-[#D4A574]/10 rounded-2xl flex items-center justify-center mx-auto mb-4">
                <CheckCircle className="h-7 w-7 text-[#773141]" />
              </div>
              <h3 className="text-lg font-semibold mb-2">Book & Pay</h3>
              <p className="text-muted-foreground text-sm leading-relaxed">
                Reserve your spot before kickoff. Pay securely through Stripe. No cash needed on game day.
              </p>
            </div>
            <div className="texttext-center p-6 rounded-2xl border bg-card hover:shadow-lg transition-shadow">
              <div className="w-14 h-14 bg-[#D4A574]/10 rounded-2xl flex items-center justify-center mx-auto mb-4">
                <Zap className="h-7 w-7 text-[#773141]" />
              </div>
              <h3 className="text-lg font-semibold mb-2">Park & Go</h3>
              <p className="text-muted-foreground text-sm leading-relaxed">
                Follow directions to your reserved spot. Walk or take the Metro to the stadium. Enjoy the event.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="container mx-auto px-4">
          <div className="grid lg:grid-cols-2 gap-8">
            ...
            <div className="bg-background rounded-2xl p-8 border shadow-sm">
              ...
              <ul className="space-y-4">
                <li className="flex items-start gap-3">
                  <Shield className="h-5 w-5 text-[#773141] mt-0.5 shrink-0" />
                  <div>
                ...
                <li className="flex items-start gap-3">
                  <DollarSign className="h-5 w-5 text-[#773141] mt-0.5 shrink-0" />
                  <div>
                ...
                <li className="flex items-start gap-3">
                  <Clock className="h-5 w-5 text-[#773141] mt-0.5 shrink-0" />
                  <div>
                    <p className="font-medium text-sm">Book in Advance</p>
                    <p className="text-sm text-muted-foreground">Reserve days before the Commanders game. Never circle the lot on game day.</p>
                  </div>
                </li>
              </ul>
              <LinkButton href="/search" className="w-full mt-6 bg-[#773141] hover:bg-[#5A1A28]">
                Find Parking
            ...
            <div className="bg-background rounded-2xl p-8 border shadow-sm">
              ...
              <ul className="space-y-4">
                <li className="flex items-start gap-3">
                  <Car className="h-5 w-5 text-[#773141] mt-0.5 shrink-0" />
                  <div>
                ...
                <li className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">Your unused spot earns money. Top hosts near NW Stadium make $500+/season.</p>
                  </div>
                </li>
                <li className="flex items-start gap-3">
                  <Shield className="h-5 w-5 text-[#773141] mt-0.5 shrink-0" />
      ...
      {/* Upcoming Commanders Games Teaser */}
      <section className="py-16 lg:py-24 bg-background">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold mb-3">Upcoming at Northwest Stadium</h2>
            <p className="text-muted-foreground">Book parking before tickets sell out</p>
          </div>
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4">
            {[
              { date: "Aug 14", opp: "vs Dolphins", time: "7:00 PM", type: "Preseason" },
              { date: "Sep 27", opp: "vs Seahawks", time: "1:00 PM", type: "Regular" },
              { date: "Oct 11", opp: "vs Giants", time: "1:00 PM", type: "NFC East" },
              { date: "Nov 1", opp: "vs Eagles", time: "8:20 PM", type: "SNF" },
            ].map((game) => (
              <div key={game.date} className="p-4 rounded-xl border bg-card hover:shadow-md transition-all cursor-pointer">
                <div className="flex items-center justify-between mb-2">
                  <span className="text-xs font-medium text-[#773141] bg-[#773141]/10 px-2 py-0.5 rounded-full">{game.type}</span>
                  <span className="text-xs text-muted-foreground">{game.time}</span>
                </div>
                <p className="font-bold text-lg">Commanders {game.opp}</p>
                <p className="text-sm text-muted-foreground mt-1">Northwest Stadium &middot; {game.date}</p>
              </div>
            ))}
          </div>
            ...
            {testimonials.map((t) => (
              <div key={t.name} className="p-6 rounded-2xl border bg-card hover:shadow-lg transition-shadow">
                ...
                <div className="flex items-center gap-2">
                  <div className="w-8 h-8 bg-[#773141]/10 rounded-full flex items-center justify-center text-sm font-bold text-[#773141]">
                    {t.name.charAt(0)}
                  </div>
                  <div>
      ...
      <section className="py-16 bg-background border-y">
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
            <div>
              <p className="text-3xl font-bold text-[#773141]">150+</p>
              <p className="text-sm text-muted-foreground mt-1">Parking Spots</p>
            </div>
            <div>
              <p className="text-3xl font-bold text-[#773141]">9</p>
              <p className="text-sm text-muted-foreground mt-1">Commanders Home Games</p>
            </div>
            <div>
              <p className="text-3xl font-bold text-[#773141]">4K+</p>
              <p className="text-sm text-muted-foreground mt-1">Bookings Made</p>
            </div>
            <div>
              <p className="text-3xl font-bold text-[#773141]">4.9</p>
      ...
      <section className="py-16 lg:py-20 bg-background">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-3xl font-bold mb-4">Stop Overpaying for Game Day Parking</h2>
          <p className="text-muted-foreground max-w-lg mx-auto mb-8">
            Join thousands of DMV fans who park smarter and earn more with ParkIt.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <LinkButton size="lg" href="/auth/signup" className="bg-[#773141] hover:bg-[#5A1A28]">
              Create Free Account
